...
import com.portal.rh.employee.exception.NoSuchEmployeeException;
...
import com.portal.rh.employee.service.persistence.EmployeeUtil;
...
public class EmployeePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByDepartmentAndActive;
	private FinderPath _finderPathWithoutPaginationFindByDepartmentAndActive;
	private FinderPath _finderPathCountByDepartmentAndActive;

	/**
	 * Returns all the employees where departmentId = &#63; and active = &#63;.
	 *
	 ...
	 */
	@Override
	public List<Employee> findByDepartmentAndActive(
		long departmentId, boolean active) {

		return findByDepartmentAndActive(
			departmentId, active, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the employees where departmentId = &#63; and active = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Employee> findByDepartmentAndActive(
		long departmentId, boolean active, int start, int end) {

		return findByDepartmentAndActive(
			departmentId, active, start, end, null);
	}

	/**
	 * Returns an ordered range of all the employees where departmentId = &#63; and active = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeeModelImpl</code>.
	 * </p>
	...
	public List<Employee> findByDepartmentAndActive(
		...
		return findByDepartmentAndActive(
			departmentId, active, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByDepartmentAndActive(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByDepartmentAndActive;
				finderArgs = new Object[] {departmentId, active};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByDepartmentAndActive;
			finderArgs = new Object[] {
				departmentId, active, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_DEPARTMENTANDACTIVE_DEPARTMENTID_2);

			sb.append(_FINDER_COLUMN_DEPARTMENTANDACTIVE_ACTIVE_2);
	...
	/**
	 * Returns the first employee in the ordered set where departmentId = &#63; and active = &#63;.
	 *
	 * @param departmentId the department ID
	 * @param active the active
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Employee findByDepartmentAndActive_First(
			long departmentId, boolean active,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByDepartmentAndActive_First(
			departmentId, active, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByDepartmentAndActive_First(
		long departmentId, boolean active,
		OrderByComparator<Employee> orderByComparator) {

		List<Employee> list = findByDepartmentAndActive(
			departmentId, active, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last employee in the ordered set where departmentId = &#63; and active = &#63;.
	 *
	 * @param departmentId the department ID
	 * @param active the active
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Employee findByDepartmentAndActive_Last(
			long departmentId, boolean active,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		Employee employee = fetchByDepartmentAndActive_Last(
			departmentId, active, orderByComparator);
	 ...
	 */
	@Override
	public Employee fetchByDepartmentAndActive_Last(
		long departmentId, boolean active,
		OrderByComparator<Employee> orderByComparator) {

		int count = countByDepartmentAndActive(departmentId, active);
		...
		List<Employee> list = findByDepartmentAndActive(
			departmentId, active, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the employees before and after the current employee in the ordered set where departmentId = &#63; and active = &#63;.
	 *
	 * @param employeeId the primary key of the current employee
	 * @param departmentId the department ID
	 * @param active the active
	 ...
	 */
	@Override
	public Employee[] findByDepartmentAndActive_PrevAndNext(
			long employeeId, long departmentId, boolean active,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
		...
		try {
			...
			array[0] = getByDepartmentAndActive_PrevAndNext(
				session, employee, departmentId, active, orderByComparator,
				true);

			array[1] = employee;

			array[2] = getByDepartmentAndActive_PrevAndNext(
				session, employee, departmentId, active, orderByComparator,
				false);
	...
	protected Employee getByDepartmentAndActive_PrevAndNext(
		Session session, Employee employee, long departmentId, boolean active,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the employees where departmentId = &#63; and active = &#63; from the database.
	 *
	 * @param departmentId the department ID
	 * @param active the active
	 */
	@Override
	public void removeByDepartmentAndActive(long departmentId, boolean active) {
		for (Employee employee :
				findByDepartmentAndActive(
					departmentId, active, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of employees where departmentId = &#63; and active = &#63;.
	 *
	 * @param departmentId the department ID
	 * @param active the active
	 * @return the number of matching employees
	 */
	@Override
	public int countByDepartmentAndActive(long departmentId, boolean active) {
		FinderPath finderPath = _finderPathCountByDepartmentAndActive;

		Object[] finderArgs = new Object[] {departmentId, active};
	...
	private static final String
		_FINDER_COLUMN_DEPARTMENTANDACTIVE_DEPARTMENTID_2 =
			"employee.departmentId = ? AND ";

	private static final String _FINDER_COLUMN_DEPARTMENTANDACTIVE_ACTIVE_2 =
		"employee.active = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByDepartmentAndActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByDepartmentAndActive",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"departmentId", "active_"}, true);

		_finderPathWithoutPaginationFindByDepartmentAndActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByDepartmentAndActive",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"departmentId", "active_"}, true);

		_finderPathCountByDepartmentAndActive = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByDepartmentAndActive",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"departmentId", "active_"}, false);
