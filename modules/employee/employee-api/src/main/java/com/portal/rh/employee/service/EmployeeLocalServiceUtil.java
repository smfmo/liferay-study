 ...
 * <code>com.portal.rh.employee.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.portal.rh.employee.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Employee findById(long employeeId)
		...
		return getService().findById(employeeId);
	}
	...
	public static List<Employee> getByDepartmentAndActive(
		long departmentId, boolean active) {

		return getService().getByDepartmentAndActive(departmentId, active);
	}
	...
	public static List<Employee> getEmployeeByPosition(String position) {
		return getService().getEmployeeByPosition(position);
	}
	...
	public static List<Employee> getEmployeesFromDepartment(long departmentId) {
		return getService().getEmployeesFromDepartment(departmentId);
	}
