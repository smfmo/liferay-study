...
/**
 * Provides the local service utility for EmployeeProject. This utility wraps
 * <code>com.portal.rh.employee.service.impl.EmployeeProjectLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmployeeProjectLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.portal.rh.employee.service.impl.EmployeeProjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EmployeeProject addEmployeeProject(
		EmployeeProject employeeProject) {

		return getService().addEmployeeProject(employeeProject);
	}
	 ...
	 */
	public static EmployeeProject createEmployeeProject(
		long employeeProjectId) {

		return getService().createEmployeeProject(employeeProjectId);
	}
	 ...
	 */
	public static EmployeeProject deleteEmployeeProject(
		EmployeeProject employeeProject) {

		return getService().deleteEmployeeProject(employeeProject);
	}
	 ...
	 */
	public static EmployeeProject deleteEmployeeProject(long employeeProjectId)
		throws PortalException {

		return getService().deleteEmployeeProject(employeeProjectId);
	}
	...
	public static EmployeeProject fetchEmployeeProject(long employeeProjectId) {
		return getService().fetchEmployeeProject(employeeProjectId);
	}
	 ...
	 * @throws PortalException if a employee project with the primary key could not be found
	 */
	public static EmployeeProject getEmployeeProject(long employeeProjectId)
		throws PortalException {

		return getService().getEmployeeProject(employeeProjectId);
	}
	 ...
	 */
	public static List<EmployeeProject> getEmployeeProjects(
		int start, int end) {

		return getService().getEmployeeProjects(start, end);
	}
	 ...
	 */
	public static int getEmployeeProjectsCount() {
		return getService().getEmployeeProjectsCount();
	}
	 ...
	 */
	public static EmployeeProject updateEmployeeProject(
		EmployeeProject employeeProject) {

		return getService().updateEmployeeProject(employeeProject);
	}

	public static EmployeeProjectLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<EmployeeProjectLocalService>
		_serviceSnapshot = new Snapshot<>(
			EmployeeProjectLocalServiceUtil.class,
			EmployeeProjectLocalService.class);
